...
namespace WopiCobaltHost
{
    public class CobaltServer
    {
        ...
        public void Start()
        {
            ...
            m_listener.Prefixes.Add(String.Format("http://192.168.81.8:{0}/wopi/", m_port));
            m_listener.Start();
            ...
            try
            {
                ...
                try
                {
                    ...
                    if (editSession == null)
                    {
                        ...
                        editSession = new FileSession(filename, m_docsPath + "/" + filename, @"Eric", @"Eric", @"marx.yuf@gmail.com", true);
